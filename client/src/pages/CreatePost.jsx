...
const CreatePost = () => {
  // navigate back to home page, once post is created
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5">
          <button
            type="button"
            onClick={generateImg}
            className="text-white bg-green-700 font-medium rounded-md text-sum w-full sm:w-auto px-5 py-2.5 text-center"
          >
